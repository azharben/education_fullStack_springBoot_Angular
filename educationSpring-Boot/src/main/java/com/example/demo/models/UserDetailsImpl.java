...
//	private static final long serialVersionUID = 1L;
	/*
	 * private Long id; private String email; private String firstName; private
	 * String password; private Collection<? extends GrantedAuthority> authorities;
	 * 
	 * public UserDetailsImpl(Long id, String email, String firstName, String
	 * password, Collection<? extends GrantedAuthority> authorities) { this.id = id;
	 * this.email = email; this.firstName = firstName; this.password = password;
	 ...
	 * 
	 * @Override public String toString() { return "UserDetailsImpl [id=" + id +
